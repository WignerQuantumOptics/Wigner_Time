...
- the manuscript in `docs/paper/` has **local changes since the arXiv import** (`fdd2e0d`; `git log fdd2e0d..HEAD -- docs/paper/`) that have not been carried back to Overleaf — see `docs/paper/CHANGES-since-arXiv.md`;
